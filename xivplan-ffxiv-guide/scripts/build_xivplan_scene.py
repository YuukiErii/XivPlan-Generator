...
ARENA_PRESETS = {
    ...
    "udm-p1": {
        ...
        "padding": 120,
        "grid": {"type": "none"},
        "ticks": {"type": "radial", "majorStart": 0, "majorCount": 8, "minorStart": 0, "minorCount": 72},
        "backgroundImage": "/arena/udm-phase1.png",
        "backgroundOpacity": 50,
        "backgroundStatus": "local-asset",
        "sourceReason": "UDM P1 gold references use `/arena/udm-phase1.png` with radial ticks and no grid.",
    },
    "udm-p2": {
        "shape": "circle",
        "width": 600,
        ...
        "grid": {"type": "none"},
        "ticks": {"type": "radial", "majorStart": 0, "majorCount": 8, "minorStart": 0, "minorCount": 72},
        "backgroundImage": "/arena/udm-phase2.png",
        "backgroundOpacity": 40,
        "backgroundStatus": "local-asset",
        "sourceReason": "UDM P2 gold references use `/arena/udm-phase2.png` with lighter background opacity.",
    },
    "udm-p3": {
        "shape": "circle",
        "width": 600,
        ...
        "grid": {"type": "none"},
        "ticks": {"type": "radial", "majorStart": 0, "majorCount": 8, "minorStart": 0, "minorCount": 72},
        "backgroundImage": "/arena/udm-phase3.png",
        "backgroundOpacity": 50,
        "backgroundStatus": "local-asset",
        "sourceReason": "UDM P3 diagrams should prefer the local phase-three UDM arena when available.",
    },
    "udm-p4": {
        "shape": "circle",
        "width": 600,
        ...
        "grid": {"type": "none"},
        "ticks": {"type": "radial", "majorStart": 0, "majorCount": 8, "minorStart": 0, "minorCount": 72},
        "backgroundImage": "/arena/udm-p4.png",
        "backgroundOpacity": 50,
        "backgroundStatus": "local-asset",
        "sourceReason": "UDM mahjong-style P3/P4 references may use `/arena/udm-p4.png`.",
    },
    "ultimate-yokai-star-dance": {
        ...
        "backgroundOpacity": 50,
        "backgroundStatus": "local-asset",
        "sourceReason": "local UDM/Yokai P1 gold references use `/arena/udm-phase1.png`; use phase-specific `udm-p1`/`udm-p2`/`udm-p3` when the phase is known.",
        "arenaOverlays": [
            {"kind": "radial_ticks", "count": 16, "color": "#8aa0b8", "opacity": 42},
